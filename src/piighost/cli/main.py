...
app.command("on", help="Enable anonymization on the running proxy.")(state_cmd.on)
app.command("off", help="Pause anonymization (transparent passthrough).")(state_cmd.off)
